...
public class PlayerRightClickEvent extends PlayerEvent implements Cancellable {
    ...
    public PlayerRightClickEvent(@NotNull final Player who, PlayerAction action, @Nullable final ItemStack item, @Nullable final Block clickedBlock, @NotNull final BlockFace clickedFace) {
        this(who, action,item, clickedBlock, clickedFace, EquipmentSlot.HAND);
    }

    public PlayerRightClickEvent(@NotNull final Player who, PlayerAction action,@Nullable final ItemStack item, @Nullable final Block clickedBlock, @NotNull final BlockFace clickedFace, @Nullable final EquipmentSlot hand) {
        super(who);
        this.item = item;
